=================================================
| Numerical Simulation Laboratory - Exercise 05 |
=================================================
|                    Author:                    |
|                  Marco Ermolli                |
...
Code is in the file named "main.cpp".
...
Outputs are: "seed.out" and all files in folder "Risultati" (automatically updated at each run).
